...
Для того, чтобы сделать текст полужирным. Его необходимо закрыть двумя звездочками с каждой стороны (**) или двойным знаком нижнего подчеркивания (__) - **Полужирный**

Альтернативные символы нужны, для того, чтобы мы смогли совмещать сразу несколько способов в одном тексте.

Например: _текст с курсивом и с **полужирным** видом_
